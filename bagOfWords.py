...
class BagOfWords:
  ...
  This particular BagOfWords is probabilistic and will take a word with a certain probability, based on its member variable. The idea is that words that appear often will get accepted into the bag of words, whereas those that appear very sparsely will not be in the resulting bag of words. """
