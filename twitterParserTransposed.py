...
jsonFile = open('/Users/theopavlakou/Documents/Imperial/Fourth_Year/MEng_Project/TWITTER Research/Data (100k tweets from London)/twitterdataanalysis/London_100k_tweets', 'r')
...
#    setOfWords.add(word)
#print("--- Finished making list of unique words in the Tweets ---")
